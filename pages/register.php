            ...
            <article class="form-container">
                ...
                <section class="mid-container">
                    ...
                    <form action="../php/register.php" method="POST" onsubmit="validateRegister(event)">
                        ...
                        <input class="input" type="text" id="email" name="email" placeholder="Correo" />
                        <input class="input" type="password" id="password" name="password" placeholder="Contraseña" />
                        <input class="input" type="password" id="confirm-password" name="confirm-password" placeholder="Confirmar Contraseña" />
